        ...
        <div className="tab-scroll" style={{ paddingBottom: "calc(150px + env(safe-area-inset-bottom))", overflowX: "hidden", overflow: showAttrModal ? "hidden" : undefined }}>
          ...
          <div style={{ position: "relative", background: "#0f0f0f", ...bannerStyle }} className={bannerClass}>
            ...
            <div style={{ padding: "calc(env(safe-area-inset-top, 8px) + 8px) 16px 0", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              <div style={{ position: "relative" }}>
                <button
                  ...
                  style={{ background: "rgba(255,255,255,0.08)", border: "none", borderRadius: 8, padding: "6px 7px", color: "#9ca3af", cursor: "pointer" }}
                >
                ...
                {showSettings && (
                  <>
                    ...
                    {/* Dropdown — fixed so it escapes header overflow clipping */}
                    <div style={{ position: "fixed", top: "calc(env(safe-area-inset-top, 0px) + 52px)", right: 12, background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, boxShadow: "0 8px 24px rgba(0,0,0,0.18)", padding: 8, minWidth: 170, zIndex: 199 }}>
                      <button onClick={() => { setShowSettings(false); handleLogout(); }} style={{ width: "100%", padding: "10px 14px", background: "none", border: "none", borderRadius: 8, color: "#374151", fontSize: 13, fontWeight: 700, cursor: "pointer", textAlign: "left", display: "block" }}>Sign Out</button>
            ...
            <div style={{ padding: "8px 16px 14px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              <div style={{ display: "flex", alignItems: "flex-start", gap: 6, paddingRight: 4 }}>
          ...
          <div style={{ display: isMobileLayout ? "block" : "grid", gridTemplateColumns: "minmax(0, 1fr) minmax(0, 1fr)", background: "#fff", borderBottom: "1px solid #e5e7eb", minHeight: 240, width: "100%", maxWidth: "100%", overflow: "hidden" }}>
            ...
            <div style={{ minWidth: 0, borderRight: isMobileLayout ? "none" : "1px solid #e5e7eb", borderBottom: isMobileLayout ? "1px solid #e5e7eb" : "none", padding: "12px 8px 12px", overflow: "hidden" }}>
              ...
              <button onClick={() => {
                if (!subPerks?.attrDetails) {
                  setFlash && setFlash({ type: "down", msg: "📊 Attribute Details — Basic or Pro subscription required" });
                  return;
                }
                setShowAttrModal(true);
              }} style={{ display: "block", margin: "6px auto 0", background: "none", border: "none", fontSize: 10, fontWeight: 700, color: subPerks?.attrDetails ? Theme.primaryGreen : "#9ca3af", cursor: "pointer", letterSpacing: 0.5 }}>
          ...
          {showAttrModal && (() => {
            ...
            return (
              <div style={{ position: "fixed", inset: 0, background: "#f4f5f7", zIndex: 300, display: "flex", flexDirection: "column", fontFamily: "'DM Sans', sans-serif" }}>
                {/* Header — fixed at top, not sticky inside scroll container */}
                <div style={{ background: "#fff", borderBottom: "1px solid #e5e7eb", padding: "calc(env(safe-area-inset-top, 0px) + 14px) 16px 14px", display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexShrink: 0, zIndex: 10 }}>
                  <div>
                    <div style={{ fontSize: 18, fontWeight: 900, color: "#111827", letterSpacing: 0.5 }}>ATTRIBUTE BREAKDOWN</div>
                    <div style={{ fontSize: 11, color: "#9ca3af", marginTop: 2 }}>Based on your round history & self-reported performance</div>
                  </div>
                  <button onClick={() => setShowAttrModal(false)} style={{ background: "none", border: "1px solid #e5e7eb", borderRadius: "50%", width: 32, height: 32, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", color: "#6b7280", fontSize: 16, flexShrink: 0 }}>✕</button>
                </div>

                {/* Scrollable content — separate from header to avoid sticky freeze */}
                <div style={{ flex: 1, overflowY: "auto", WebkitOverflowScrolling: "touch", paddingBottom: "env(safe-area-inset-bottom, 16px)" }}>

                {/* Overview: radar + bars */}
                <div style={{ background: "#fff", margin: "12px 12px 0", borderRadius: 14, border: "1px solid #e5e7eb", padding: "14px" }}>
                  ...
                  {statEntries.map(([k, v]) => {
                    ...
                    return (
                      <div key={k} style={{ background: "#fff", borderRadius: 14, border: "1px solid #e5e7eb", overflow: "hidden" }}>
                        <div style={{ padding: "14px 14px 10px" }}>
                          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 8 }}>
                            <div style={{ display: "flex", alignItems: "center", gap: 10, flex: 1, minWidth: 0 }}>
                              <div style={{ width: 38, height: 38, borderRadius: 10, background: m.iconBg, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                                {m.icon}
                              </div>
                              <div style={{ minWidth: 0, flex: 1 }}>
                                <div style={{ display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap" }}>
                                  <span style={{ fontSize: 14, fontWeight: 900, color: "#111827", letterSpacing: 0.5 }}>{m.fullName}</span>
                                  <span style={{ fontSize: 9, fontWeight: 800, color: badge.color, background: badge.bg, border: `1px solid ${badge.border}`, borderRadius: 4, padding: "2px 5px", letterSpacing: 0.5, flexShrink: 0 }}>{badge.label}</span>
                                  <span style={{ fontSize: 13, color: trend === "up" ? "#16a34a" : trend === "down" ? "#ef4444" : "#9ca3af", flexShrink: 0 }}>
                                    {trend === "up" ? "↑" : trend === "down" ? "↓" : "→"}
                                  </span>
                                </div>
                            ...
                            <div style={{ textAlign: "right", flexShrink: 0, marginLeft: 10 }}>
                              <span style={{ fontSize: 26, fontWeight: 900, color: m.color, fontFamily: "Bebas Neue", lineHeight: 1 }}>{v}</span>
                        ...
                        <div style={{ background: m.bg, borderTop: `1px solid ${m.iconBg}`, padding: "10px 14px", display: "flex", alignItems: "flex-start", gap: 8 }}>
